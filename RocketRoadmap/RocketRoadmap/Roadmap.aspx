        ...
        <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <h2><u>Description</u></h2>
                    <textarea id="descText" rows="3" cols="75" ></textarea> 

                <!--Depedency Input -->
                <h2><u>Dependencies</u></h2>
                <button type="button" class="btn btn-default" id="addText">Free Text Dependency</button> 
                <button type="button" id="addSelect" class="btn btn-default ">Project Dependency</button>
                <!-- Free Text Input-->    
                    <div class="depText">
                        <div></div>
                    </div> 
                ...
                <!-- Risks Text Box -->
                <h2><u>Risks</u></h2>
                    <textarea id="riskText" rows="3" cols="75"></textarea> 

                <!-- Links Input -->
                <h2><u>Links</u></h2>
                    <button type="button" class="btn btn-default" id="addLink">Link</button>
                    <div class="linkText">     
                        <div></div>
                    </div>
